...
public class MainSGO {
    ...
    public static void run(boolean plotGraph, boolean saveLog, long seedDefined, String header) {
        ...
        double beginRange = Utils.getDoubleWithDefault("Limite inferior (Deixe em branco para manter o valor padrão "+SGO.DEFAULT_BEGIN_RANGE+")", -100_000, 100_000, SGO.DEFAULT_BEGIN_RANGE);
        double endRange = Utils.getDoubleWithDefault("Limite superior (Deixe em branco para manter o valor padrão "+SGO.DEFAULT_END_RANGE+")", -100_000, 100_000, SGO.DEFAULT_END_RANGE);
