...
public class GA {
    ...
    public final static double DEFAULT_BEGIN_RANGE = -100;
    public final static double DEFAULT_END_RANGE = 100;
    ...
    public GA(Function function, SelectionType selectionType) {
    ...
    public GA(int numberOfPopulation, int iterationLimit, double crossoverProbability, double mutationProbability, 
            double beginRange, double endRange, int elitism, CrossoverType crossoverType, Function function, SelectionType selectionType) {
    ...
    private double[] setUniformDistribution() {
        ...
        for(int i = 0; i < this.function.getNumberOfVariables(); ++i) {
            genes[i] = (rand.nextDouble() * (endRange - beginRange))+ beginRange;
        }
        return genes;
    }
    ...
    private Individual[] initialize() {
        ...
        for(int i = 0; i < this.numberOfPopulation; ++i) {
            ...
            population[i] = new Individual(this.function, genes);
        }
    ...
    private Individual[] crossover(Individual parent1, Individual parent2) {
        ...
        if(Math.random() <= this.crossoverProbability) {
            if(this.crossoverType == CrossoverType.ARITHMETIC_MEAN) {
                ...
                children[0] = new Individual(this.function, genes);
                ...
                children[1] = new Individual(this.function, genes);
